    ...
    <section id="contact" className="pt-24 bg-white">
      <div>
        <motion.div
          ...
          className="bg-[#ffe600]  p-8 md:p-16 relative overflow-hidden shadow-xl"
        >
          ...
          <div className="relative z-10 flex flex-col gap-12">
            ...
            <div className="flex flex-col lg:flex-row justify-between items-center gap-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4 w-full lg:w-auto">
                <a href="mailto:invest@MNM.com" className="flex items-center gap-4 bg-white/60 hover:bg-white p-2 pr-6 rounded-2xl transition-all duration-300 shadow-sm hover:shadow-md">
                  ...
                  <span className="font-bold text-[#1a1a1a]">invest@MNM.com</span>
                </a>
